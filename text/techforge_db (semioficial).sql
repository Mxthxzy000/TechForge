...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26/10/2025 às 07:22
...
(2, 'real', 'ou faike', NULL, '(12) 99117-767', 'quirinojulio77@gmail.com', '$2y$10$FNooLCvVYstKa1WX3RiHYeQpy84tIoWj7CTH79dWKy2SueGisM7Xa', '2000-08-11', '../ImagensUsuarios/2.jpg', '2025-10-26 00:46:42', 'cliente'),
...
--
ALTER TABLE `formas_pagamento`
  MODIFY `idFormaPagamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
