                ...
                <div class="payment-option">
                    <label class="payment-label">
                        ...
                        <div class="card-brands">
                            <img src="data:image/svg+xml,%3Csvg width='40' height='24' viewBox='0 0 40 24' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='40' height='24' rx='3' fill='%23E8E8E8'/%3E%3Ccircle cx='14' cy='12' r='6' fill='%23EB001B'/%3E%3Ccircle cx='26' cy='12' r='6' fill='%23F79E1B'/%3E%3C/svg%3E" alt="Mastercard">
                            <img src="data:image/svg+xml,%3Csvg width='40' height='24' viewBox='0 0 40 24' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='40' height='24' rx='3' fill='%231434CB'/%3E%3Ctext x='50%25' y='50%25' dominant-baseline='middle' text-anchor='middle' fill='white' font-family='Arial' font-weight='bold' font-size='10'%3EVISA%3C/text%3E%3C/svg%3E" alt="Visa">
                            <img src="data:image/svg+xml,%3Csvg width='40' height='24' viewBox='0 0 40 24' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='40' height='24' rx='3' fill='%23006FCF'/%3E%3Ctext x='50%25' y='50%25' dominant-baseline='middle' text-anchor='middle' fill='white' font-family='Arial' font-weight='bold' font-size='8'%3EAMEX%3C/text%3E%3C/svg%3E" alt="Amex">
                            <img src="data:image/svg+xml,%3Csvg width='40' height='24' viewBox='0 0 40 24' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='40' height='24' rx='3' fill='%23FF6000'/%3E%3Ctext x='50%25' y='50%25' dominant-baseline='middle' text-anchor='middle' fill='white' font-family='Arial' font-weight='bold' font-size='7'%3EELO%3C/text%3E%3C/svg%3E" alt="Elo">
                            <img src="data:image/svg+xml,%3Csvg width='40' height='24' viewBox='0 0 40 24' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='40' height='24' rx='3' fill='%23000000'/%3E%3Ctext x='50%25' y='50%25' dominant-baseline='middle' text-anchor='middle' fill='white' font-family='Arial' font-weight='bold' font-size='6'%3EHIPER%3C/text%3E%3C/svg%3E" alt="Hipercard">
                            <img src="data:image/svg+xml,%3Csvg width='40' height='24' viewBox='0 0 40 24' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='40' height='24' rx='3' fill='%23808080'/%3E%3C/svg%3E" alt="Outros">
                        </div>
                    </label>
                    <div class="payment-details active" id="credit-card-details">
                        <div class="ssl-notice">
                            <svg class="lock-icon" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                ...
                                <path d="M5 7V5C5 3.34315 6.34315 2 8 2C9.65685 2 11 3.34315 11 5V7" stroke="#10B981" stroke-width="2"/>
                            </svg>
                        ...
                        <form class="credit-card-form" id="credit-card-form">
                            ...
                            <div class="form-row">
                                <div class="form-group full-width">
                                    <input type="text" id="card-number" placeholder="Número do cartão *" maxlength="19" required>
                                </div>
                            </div>

                            <div class="form-row">
                                <div class="form-group full-width">
                                    <input type="text" id="card-name" placeholder="Nome do titular do cartão *" required>
                                </div>
                            </div>

                            <div class="form-row">
                                <div class="form-group full-width">
                                    <input type="text" id="cpf" placeholder="9 x de R$ 24,88 (com 5% de desconto)" required>
                                </div>
                            </div>
        ...
        <div class="sidebar">
            ...
            <div class="summary-card">
                ...
                <div class="product-info">
                    <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Captura%20de%20tela%202025-10-20%20082254-Oj26I4mxtsOYIqCelXp3wG4OWvOknw.png" alt="Placa de Vídeo" class="product-image">
                    <div class="product-details">
                        <p class="product-name">Placa de Vídeo Gigabyte Aorus AMD Radeon RX 9070 XT Elite, 16GB, GDDR6, FSR, Ray Tracing, GV-R907XTAORUS E-16GD</p>
                    </div>
                </div>
